# Knife dataset (4500 images YOLO format electronic

# Body

Knife Dataset (4500 images in YOLO format) - electronic resource
The dataset contains rich content, covering various scenes. It is suitable for projects such as knife detection, target recognition, and model training. It can be directly used, saving time and effort
